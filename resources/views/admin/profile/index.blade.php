                    ...
                    <div class="card-body">
                        <form method="POST" class="form-material m-t-40 row" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" value="<?=$us_log->name?>" placeholder="Nombre">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="email">Correo</label>
                                <input type="email" name="email" class="form-control" value="<?=$us_log->email?>" placeholder="Correo">
                            </div>
                            <div class="form-group col-md-6">
