                    ...
                    <div class="card-body">
                        <form method="POST" class="form-material m-t-40 row" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="lastname" id="lastname" class="form-control" value="{{ old('lastname') }}" placeholder="Apellidos">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="phone" id="phone" class="form-control" value="{{ old('phone') }}" placeholder="Celular">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="country">Pa&iacute;s</label>
                                <input type="text" name="country" id="country" class="form-control" value="{{ old('country') }}" placeholder="Pa&iacute;s">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="client">Cliente</label>
                                <input type="text" name="client" id="client" class="form-control" value="{{ old('client') }}" placeholder="Cliente">
                            </div>
