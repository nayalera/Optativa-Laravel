...
@section('content')
    ...
    <section class="banner-three p_relative pb_160">
        ...
        <div class="bg-layer p_absolute t_0 r_0 wow slideInDown animated" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url({{ asset('front/img/banner-1.png') }});"></div>
    ...
    <!-- about-12 -->
    <section class="about-12 p_relative sec-pad" id=nosotros>
        <div class="auto-container">
                    ...
                    <div class="content_block_nine">
                        <div class="content-box p_relative d_block ml_40">
                            ...
                            <div class="text p_relative d_block mb_35">
                                ...
                                <p class="font_family_poppins">{{ trans('home.message_5') }}</p>
                            </div>
                            {{-- <div class="btn-box">
    ...
    <!-- service-12 -->
    <section class="service-12 p_relative centred sec-pad" id="servicios">
        <div class="auto-container">
            ...
            <div class="row clearfix">
                    ...
                    <div class="service-block-10 wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block b_radius_10 pt_60 pl_30 pb_50 pr_30 tran_5 mb_30">
                            ...
                            <div class="lower-content">
                                <h3 class="d_block fs_24 lh_30 fw_sbold font_family_jost mb_17"><a href="javascript:void(0);" class="d_iblock color_black">{{ trans('home.message_6') }}</a></h3>
                                <p class="fs_16 font_family_poppins mb_25 lh_28">{{ trans('home.message_7') }}</p>
                                <div class="link">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-10 wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block b_radius_10 pt_60 pl_30 pb_50 pr_30 tran_5 mb_30">
                            ...
                            <div class="lower-content">
                                <h3 class="d_block fs_24 lh_30 fw_sbold font_family_jost mb_17"><a href="javascript:void(0);" class="d_iblock color_black">{{ trans('home.message_6') }}</a></h3>
                                <p class="fs_16 font_family_poppins mb_25 lh_28">{{ trans('home.message_8') }}</p>
                                <div class="link">
                                    {{-- <a href="javascript:void(0);" class="d_iblock p_relative fs_15 fw_sbold font_family_poppins color_black">Learn more<i class="icon-4"></i></a> --}}
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-10 wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block b_radius_10 pt_60 pl_30 pb_50 pr_30 tran_5">
                            <div class="icon-box p_relative d_iblock fs_45 mb_30">
                                <div class="shape-1 l_0 t_0 hero-shape-four p_absolute tran_5"></div>
                                <div class="shape-2 p_absolute l_0 t_5" style="background-image: url({{ asset('front/img/shape-138.png') }});"></div>
                                <div class="icon"><i class="icon-89"></i></div>
                                <div class="icon-img hidden-icon"><img src="{{ asset('front/img/hid-icon-72.png') }}" alt=""></div>
                            </div>
                            <div class="lower-content">
                                <h3 class="d_block fs_24 lh_30 fw_sbold font_family_jost mb_17"><a href="javascript:void(0);" class="d_iblock color_black">{{ trans('home.message_6') }}</a></h3>
                                <p class="fs_16 font_family_poppins mb_25 lh_28">{{ trans('home.message_9') }}</p>
                                <div class="link">
                                    {{-- <a href="javascript:void(0);" class="d_iblock p_relative fs_15 fw_sbold font_family_poppins color_black">Learn more<i class="icon-4"></i></a> --}}
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-10 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block b_radius_10 pt_60 pl_30 pb_50 pr_30 tran_5">
                            <div class="icon-box p_relative d_iblock fs_45 mb_30">
                                <div class="shape-1 l_0 t_0 hero-shape-four p_absolute tran_5"></div>
                                <div class="shape-2 p_absolute l_0 t_5" style="background-image: url({{ asset('front/img/shape-140.png') }});"></div>
                                <div class="icon"><i class="icon-90"></i></div>
                                <div class="icon-img hidden-icon"><img src="{{ asset('front/img/hid-icon-73.png') }}" alt=""></div>
                            </div>
                            <div class="lower-content">
                                <h3 class="d_block fs_24 lh_30 fw_sbold font_family_jost mb_17"><a href="javascript:void(0);" class="d_iblock color_black">{{ trans('home.message_6') }}</a></h3>
                                <p class="fs_16 font_family_poppins mb_25 lh_28">{{ trans('home.message_9') }}</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                    <div class="service-block-10 wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block b_radius_10 pt_60 pl_30 pb_50 pr_30 tran_5">
                            <div class="icon-box p_relative d_iblock fs_45 mb_30">
                                <div class="shape-1 l_0 t_0 hero-shape-four p_absolute tran_5"></div>
                                <div class="shape-2 p_absolute l_0 t_5" style="background-image: url({{ asset('front/img/shape-142.png') }});"></div>
                                <div class="icon"><i class="icon-91"></i></div>
                                <div class="icon-img hidden-icon"><img src="{{ asset('front/img/hid-icon-74.png') }}" alt=""></div>
                            </div>
                            <div class="lower-content">
                                <h3 class="d_block fs_24 lh_30 fw_sbold font_family_jost mb_17"><a href="javascript:void(0);" class="d_iblock color_black">{{ trans('home.message_6') }}</a></h3>
                                <p class="fs_16 font_family_poppins mb_25 lh_28">{{ trans('home.message_9') }}</p>
                                <div class="link">
                                    {{-- <a href="service-details.html" class="d_iblock p_relative fs_15 fw_sbold font_family_poppins color_black">Learn more<i class="icon-4"></i></a> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_five">
                        <div class="content-box p_relative d_block mr_30">
                            <div class="sec-title-nine p_relative d_block mb_25">
                                <h6 class="d_iblock pl_20 pr_20 fs_14 lh_30 b_radius_5 mb_18 fw_medium font_family_poppins">{{ trans('home.message_11') }}</h6>
                                <h2 class="d_block fs_45 lh_55 fw_bold font_family_jost">{{ trans('home.message_11') }}</h2>
                            </div>
                            <ul class="accordion-box">
                                <li class="accordion block active-block p_relative d_block">
                                    <div class="acc-btn active p_relative d_block tran_5 pt_16 pr_80 pb_16 pl_30">
                                        ...
                                        <h5 class="p_relative d_block fs_20 lh_28 fw_medium font_family_jost">{{ trans('home.message_12') }}</h5>
                                    </div>
                                    <div class="acc-content current p_relative pt_25 pr_50 pb_25 pl_30">
                                        <div class="text p_relative d_block">
                                            <p class="font_family_poppins">{{ trans('home.message_12') }}</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block p_relative d_block">
                                    <div class="acc-btn p_relative d_block tran_5 pt_16 pr_80 pb_16 pl_30">
                                        <div class="icon-outer p_absolute fs_10 tran_5 z_1"><i class="icon-29"></i></div>
                                        <h5 class="p_relative d_block fs_20 lh_28 fw_medium font_family_jost">{{ trans('home.message_13') }}</h5>
                                    </div>
                                    <div class="acc-content p_relative pt_25 pr_50 pb_25 pl_30">
                                        <div class="text p_relative d_block">
                                            <p class="font_family_poppins">{{ trans('home.message_13') }}</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block p_relative d_block">
                                    <div class="acc-btn p_relative d_block tran_5 pt_16 pr_80 pb_16 pl_30">
                                        <div class="icon-outer p_absolute fs_10 tran_5 z_1"><i class="icon-29"></i></div>
                                        <h5 class="p_relative d_block fs_20 lh_28 fw_medium font_family_jost">{{ trans('home.message_14') }}</h5>
                                    </div>
                                    <div class="acc-content p_relative pt_25 pr_50 pb_25 pl_30">
                                        <div class="text p_relative d_block">
                                            <p class="font_family_poppins">{{ trans('home.message_14') }}</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="datos-oportunidad news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        ...
                        <div class="inner-box">
                            ...
                            <div class="row pt_30 pr_30 pb_30 pl_30 ">
                                <div class="col-sm-2">
                                    <figure class="image b_radius_10"><a href="{{ url('busquedas-activas/'.((config('app.locale')=='es')?$value->slug:$value->slug_en)) }}"><?php if(!$value->confidential){ ?><img src="{{ '/storage/'.$value->logo }}" class="" alt=""><?php }else{ ?><img src="{{ asset('front/img/default.jpg') }}" class="" alt=""><?php } ?></a></figure>
                                </div>
                                <div class="col-sm-3">
                        ...
                        <form method="post" action="{{ url('contact') }}" id="contact-form">
                            <div class="row clearfix">
                                ...
                                @if (session()->has('form_errors'))
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        <div class="alert alert-danger alert-lng">{{ session()->get('form_errors') }}</div>
                                    </div>
                                @endif
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <div class="g-recaptcha" required data-sitekey="6LcA1GgkAAAAABpp-CXI0fm_wGZwZM6DRZ7-BOya" data-callback="correctCaptcha"></div>
                                </div>
